...
const colorThemes = {
  ...
  light: {
    ...
    titleBorder: `border-s-${defaultThemeValue}-600 dark:border-s-${defaultThemeValue}-600`,
    cssVar: `var(--color-${defaultThemeValue}-600)`,
  ...
  dark: {
    ...
    cssVar: `color-${defaultThemeValue}-400`,
