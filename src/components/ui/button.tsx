...
const base = [
  ...
  "focus-visible:outline-none focus-visible:border-wt-400",
...
const buttonVariants = cva(base.join(" "), {
  variants: {
    variant: {
      ...
      ghost:
        "hover:bg-slate-100 hover:border-wt-400 hover:text-slate-900 dark:hover:bg-slate-800 dark:hover:text-slate-50",
